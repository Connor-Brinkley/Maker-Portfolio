...
<div style="display: flex; justify-content: center; margin-bottom: 20px; line-height: 0;">
  <img src="./images/2.0.jpg" alt="photo" style="max-width:40%; height:auto; transform: rotate(-90deg); display: block; margin: -5px 0;">
</div>
