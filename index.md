...
# Hexpod
This project I will be modifying a Freenove hexpod with a usb microphone, speaker, a 8 by 8 led screen, and a rasberry pi model 4 b. My end goal is to have an "Alexa on legs", It will use llm's for[...]
## Blueprints
As you can see below these were earler blueprints i had made, each of these had their own compications.
<div class="page-full" style="display: flex; gap: 20px;">
